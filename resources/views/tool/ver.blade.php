...
<div class="relative flex justify-center space-x-2">
    ...
    <div class="group relative">
        <button id="draw" class="btnimg" onclick="window.location.href='{{ route('tool.measurements', $tool->id) }}'"><img src="{{ asset('storage/assets/images/draw.png') }}" width="50" height="50"></button>
...
<div class="max-w-6xl mx-auto bg-white rounded-xl p-3 text-gray-900 shadow-md">
    ...
    <div class="flex justify-center"><img src="{{ asset('storage/tools/'.$tool->tool_uri)}}" width="128" alt="Tool preview" 
            class="rounded-lg shadow-md w-32 h-auto object-cover" /></div>
        <div class="txt flex justify-center hover:text-cyan-600"><a href="{{ route('tool.show', $tool->id) }}"> {{ $tool->tool_date }} </a></div>
        <div class="txt flex justify-center hover:text-cyan-600"><a href="{{ route('tool.show', $tool->id) }}"> {{ $tool->tool_tomography_id }} </a></div>  
