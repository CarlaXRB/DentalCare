...
@section('title', __('Create Tomography Folder'))
@section('subtitle')
    {{ __('Create Tomography Folder') }}
@endsection
...
<div class="bg-white rounded-lg max-w-5xl mx-auto p-6 shadow-md">
    <form method="POST" action="{{ route('tomography.storedcm') }}" enctype="multipart/form-data">
        ...
        <h1 class="title1 text-center mb-8">{{ __('Upload Tomography Folder') }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="title4 block mb-2">{{ __('Upload Folder') }}:</label>
        ...
        <div class="flex justify-center mt-6">
            <button type="submit" class="botton2">{{ __('Upload Folder') }}</button>
        </div>
    </form>
</div>
@endsection
