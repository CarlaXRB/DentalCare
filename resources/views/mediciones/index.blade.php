...
@section('subtitle', __('Subir Estudio Multimedia'))
...
<div class="max-w-5xl mx-auto p-6">
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 space-y-4">
        <form id="measureForm" enctype="multipart/form-data" method="POST" action="{{ route('analyze') }}">
            @csrf
...
document.getElementById('measureForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        output.innerText = "Error en la conexión: " + err.message;
    }
});
</script>
@endsection
