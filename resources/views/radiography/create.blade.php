...
<div class="bg-white rounded-lg max-w-5xl mx-auto p-6">
    <form method="POST" action="{{ route('radiography.store') }}" enctype="multipart/form-data">
        ...
        <h1 class="title1 text-center mb-8">{{ __('Enter Radiography Information') }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="radiography_id" value="{{ old('radiography_id') }}"
            ...
            <div>
                ...
                <input type="date" name="radiography_date" value="{{ old('radiography_date') }}"
                    class="border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-cyan-500"/>
            ...
            <div>
                ...
                <input type="text" name="radiography_type" value="{{ old('radiography_type') }}"
                    class="border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-cyan-500"/>
            ...
            <div>
                ...
                <input type="file" name="radiography_file"
                    class="border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-cyan-500"/>
                @error('radiography_file') <p class="error mt-1">{{ $message }}</p> @enderror
            </div>
        ...
        <div class="flex justify-center mt-6">
            <button type="submit" class="botton2">{{ __('Upload Radiography') }}</button>
        </div>
    </form>
</div>
@endsection
